...
const addon = require("./app/addon")(prisma);
const matchEvent = require("./app/matchEvent")(prisma);
...
app.use(config.baseApiPath, addon);
app.use(config.baseApiPath, matchEvent);
